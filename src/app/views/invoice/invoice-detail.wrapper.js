...
class InvoiceDetailWrapper extends React.Component {
	constructor(props) {
		super(props);
	...
	preFetch() {
		...
		q.fcall(fetchInvoiceData).then(fetchDunningList).then(whenRequestsDone).catch(onFetchError).done();
	}
...
export default connect(mapStateToProps)(InvoiceDetailWrapper);
