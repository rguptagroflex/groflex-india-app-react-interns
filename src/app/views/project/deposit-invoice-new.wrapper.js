...
class DepositInvoiceNewWrapper extends React.Component {
    constructor(props) {
		super(props);
    ...
    preFetch ()  {
		...
		Promise.all([
			invoiz.request(`${config.depositInvoice.endpoints.createNewDepositInvoice}?projectId=${parsedProjectId}`, {
				auth: true
			}),
...
export default connect(mapStateToProps)(DepositInvoiceNewWrapper);
