...
// class ChartOfAccountPersonModalComponent extends React.Component {
// 	constructor(props) {
// 		super(props);
...
function ChartOfAccountPersonModalComponent({ formData, onConfirm }) {
	useEffect(() => {
			...
			<div style={{ padding: "10px", backgroundColor: "#f5f5f5" }}>
				<div style={{ padding: "35px 30px", backgroundColor: "white" }}>
					...
					<div className="textarea">
						<label className="textarea_label">Description (optional)</label>
						<textarea
