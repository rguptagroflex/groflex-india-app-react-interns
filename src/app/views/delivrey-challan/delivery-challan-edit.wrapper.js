...
class DeliveryChallanEditWrapper extends React.Component {
	constructor(props) {
		super(props);
		...
		Promise.all([
			...
			.then(
				([
					...
					const challan = new Invoice(challanData);
					...
					// if (!challan.invoizPayData) {
					// 	challan.setInvoizPayData(accountData);
					// }
...
export default connect(mapStateToProps)(DeliveryChallanEditWrapper);
