					...
					<div className="row">
						...
						{pathName == "/settings/more-settings/article" ? 
							...
							<div className="col-xs-12 u_pbt_20">
								...
								<div className="col-xs-12">
									<TagInputComponent
										hintText={format(resources.tagDefaultHintMessage, resources.str_articleUnits)}
												...
												.then(response => {
													...
													ModalService.open(
														<TagReplaceModal
															...
															tags={tagsForDelete}
															tagToDelete={tag}
															replaceUrl={config.settings.endpoints.replaceArtilceUnit}
															onSaveClick={setting => {
																callback(setting);
																ModalService.close();
															}}
						...
						{pathName == "/settings/more-settings/article-categories" ? 
							...
							<div className="col-xs-12 u_pbt_20">
								...
								<div className="col-xs-12">
									<TagInputComponent
										hintText={format(resources.tagDefaultHintMessage, resources.str_articleCategories)}
