...
class cashAndFlowSendEmail extends React.Component {
	// componentDidMount() {
				...
				>
					...
					>
						...
						>
							...
							<div className="row cash-flow-email-bottom">
								<div className="col-xs-12">
										...
										<div className="row">
											<div className="col-xs-7">
												...
												{this.state.uploadedAttachments.length < 10 ? (
													<div>
														<div className="cash-flow-email-radio">
															<RadioInputComponent
																useCustomStyle={true}
																value={exportFormat}
																onChange={(value) =>
...
export default cashAndFlowSendEmail;
