...
const DateFilterType = Object.freeze({
    NONE: 'none',
...
class DashboardSalesByCustomerStatsComponent extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        // } else 
        if(prevState.customerSalesList != this.state.customerSalesList) {
...
export default DashboardSalesByCustomerStatsComponent;
