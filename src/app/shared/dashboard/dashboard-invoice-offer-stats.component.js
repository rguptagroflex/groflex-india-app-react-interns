...
import { formatCurrencyTruncated, formatCurrencySymbolDisplayInFront } from 'helpers/formatCurrency'; // formatCurrency
import { fetchStatsData } from 'redux/ducks/dashboard/invoiceOfferStats';
import WebStorageService from 'services/webstorage.service';
import WebStorageKey from 'enums/web-storage-key.enum';

class DashboardInvoiceOfferStatsComponent extends React.Component {
	componentDidMount() {
		this.refresh();
	}
	...
	render() {
		...
		const content = errorOccurred ? (
			<div>
				<div className="widgetContainer box small-stats-box">
			...
			<div>
				<WidgetComponent loaderText={resources.str_dataLoader} loading={isLoading} containerClass="small-stats-box">
						...
						<div className="box-content">
							<div className="left-content">
								...
								<div
									...
									onClick={() => this.navigateToView('/invoices', true, statsData.invoiceStats.count)}
								>
									{/* {formatCurrency(statsData.invoiceStats.total)} */}
									{formatCurrencySymbolDisplayInFront(statsData.invoiceStats.total)}
								</div>
							</div>
							<div className="right-content">
								<div className="stats-label text-muted">{resources.str_number}</div>
								<div
									className="stats-value"
									onClick={() => this.navigateToView('/invoices', true, statsData.invoiceStats.count)}
								>
				...
				<WidgetComponent loaderText={resources.str_dataLoader} loading={isLoading} containerClass="small-stats-box">
					<div className="box-header">
						...
						>
							{resources.dashboardOpenOffers} <span className="icon icon-arr_right text-muted" />
						</div>
					</div>
