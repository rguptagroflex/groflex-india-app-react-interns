...
class PaymentConditionsComponent extends React.Component {
	constructor(props) {
		super(props);
					...
					<div className="row u_pb_20">
						...
						<div className="col-xs-6 select-default-option">
							<ButtonComponent
								...
								type="primary"
								callback={() => this.onTopbarButtonClick()}
...
export default PaymentConditionsComponent;
