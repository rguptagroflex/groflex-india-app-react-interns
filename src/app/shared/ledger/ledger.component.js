...
class LedgerComponent extends React.Component {
	...
	getSelectizeDateOptions() {
		...
		const dateArray = [
			...
			{ label: `Quarter ${currentQuater.quarter}/${currentQuater.year}`, value: 'currentQuater', group: 'quarter',quarter:currentQuater },
			{ label: `Quarter ${lastQuater.quarter}/${lastQuater.year}`, value: 'lastQuater', group: 'quarter',quarter:lastQuater },
			{ label: `Quarter ${secondlastQuater.quarter}/${secondlastQuater.year}`, value: 'secondlastQuater', group: 'quarter',quarter:secondlastQuater },
		...
		return (
			<div className='customer-statements-container' >
					...
					<div className="row first-row">
						<div className=" col-xs-6 col-no-gutter-left document-export-date">
						...
						<div className='col-xs-6 col-gutter-left-30 export-type'>
								<RadioInputComponent
									useCustomStyle={true}
									value={exportFormat}
					...
					{dateOption && dateOption.value==='custom' ? (
						...
						<div className='col-xs-6  col-gutter-left-60 statement-action'>
						<ButtonComponent
								buttonIcon={''}
								type="primary"
